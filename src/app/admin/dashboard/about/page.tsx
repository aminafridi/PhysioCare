...
import { Save, Plus, CheckCircle, Loader2, Upload, User, AlertCircle, X } from 'lucide-react';
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <Button onClick={handleSave} className="gap-2 w-full sm:w-auto min-h-[48px]" disabled={saving || !!uploadError}>
                    {saving ? (
            ...
            <div className="bg-white dark:bg-secondary-800 rounded-xl p-4 sm:p-6 shadow-sm border border-secondary-200 dark:border-secondary-700">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
                    <div className="relative w-28 h-28 sm:w-32 sm:h-32 rounded-full overflow-hidden bg-secondary-100 dark:bg-secondary-700 flex items-center justify-center border-2 border-secondary-200 dark:border-secondary-600 shadow-inner flex-shrink-0">
                        {data.imageUrl ? (
                            <Image
                                src={data.imageUrl}
                                alt="Doctor profile"
                            ...
                            <User className="w-14 h-14 sm:w-16 sm:h-16 text-secondary-400" />
                        )}
                    </div>
                    <div className="flex-1 w-full text-center sm:text-left">
                        ...
                        <Button
                            ...
                            variant="secondary"
                            disabled={saving}
                            className="gap-2 mb-3 w-full sm:w-auto min-h-[48px]"
                        >
            ...
            <div className="bg-white dark:bg-secondary-800 rounded-xl p-4 sm:p-6 shadow-sm border border-secondary-200 dark:border-secondary-700">
                ...
                <div className="space-y-2 sm:space-y-3 mb-4">
                    {data.qualifications.map((qual, index) => (
                        <div
                            key={index}
                            className="flex items-center justify-between gap-3 p-3 bg-secondary-50 dark:bg-secondary-700 rounded-lg"
                        >
                            <span className="text-sm sm:text-base text-secondary-900 dark:text-white flex-1">{qual}</span>
                            <button
                                onClick={() => removeQualification(index)}
                                className="p-2 text-red-500 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center flex-shrink-0"
                            >
                                <X className="w-4 h-4" />
                            </button>
                        </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    />
                    <Button onClick={addQualification} variant="secondary" className="min-h-[48px] gap-2">
