...
export default function ServiceDetailPage() {
    ...
    useEffect(() => {
        async function loadService() {
            ...
            const dbService = await getService(slug); // Assuming ID matches slug for simplicity or refactor getService to query by slug
            // Note: In current app, ID is the slug for static data. Firestore might differ.
            // For now, let's assume getService(slug) works if we use custom IDs, OR we fallback to static.
